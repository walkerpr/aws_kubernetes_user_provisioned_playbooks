...
Inventory file should set iamge registry fqdn. Certs must exist in opt/sample/server for the image registry. Additionally vars shoudl be set for the AA_ARTIFACTORY_USERNAME and AA_ARTIFACTORY_PASSWORD for the image pull secret to be properly utilized. 
